        ...
        <div class="col-md-7 ml-auto mr-auto">
            <div class="card card-register card-white">
                <div class="card-header">
                    <img class="card-img" src="<?php echo e(asset('assets')); ?>/img/register.png" alt="Card image" style="margin-bottom: 30px; width: 1200px; height: 120px">
...
<?php echo $__env->make('layouts.app', ['class' => 'register-page', 'page' => 'Sales & Inventory Management System', 'contentClass' => 'register-page', 'section' => 'auth'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Adones\Downloads\Inventory-Management-main\resources\views/auth/register.blade.php ENDPATH**/ ?>